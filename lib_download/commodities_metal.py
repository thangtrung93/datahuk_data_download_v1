...
l_commodities_metal = ["quang_sat","chi", "thiec", "kem",
                       "nhom", "niken", "vang_the_gioi", "vang", "bac", "dong"]

def get_commodities_metal():
    # get urls
    ...
    d_url = get_url(l_commodities_metal)
    ...
    df_quang_sat=get_df(d_json_all,"quang_sat")
    df_chi=get_df(d_json_all,"chi")
    df_thiec=get_df(d_json_all,"thiec")
    df_kem=get_df(d_json_all,"kem")
    df_nhom=get_df(d_json_all,"nhom")
    df_niken=get_df(d_json_all,"niken")
    df_vang_the_gioi=get_df(d_json_all,"vang_the_gioi")
    df_vang=get_df(d_json_all,"vang")
    df_bac=get_df(d_json_all,"bac")
    df_dong=get_df(d_json_all,"dong")


    return df_quang_sat,df_chi,df_thiec, df_kem,df_nhom,df_niken,df_vang_the_gioi, df_vang, df_bac, df_dong
