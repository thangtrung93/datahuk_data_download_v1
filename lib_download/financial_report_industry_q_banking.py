...
def get_financial_report_industry_q_banking():
    ...
    # d_json_q_bs = get_json_all(d_url_q_bs)
    ...
    d_json_q_bs_banking = get_json_all(d_url_q_bs_banking, headers_tcbs)
    d_json_q_ic_banking = get_json_all(d_url_q_ic_banking, headers_tcbs)
    d_json_q_ratio_banking = get_json_all(d_url_q_ratio_banking, headers_tcbs)
    ...
    return df_q_bs_banking, df_q_ic_banking, df_q_ratio_banking
