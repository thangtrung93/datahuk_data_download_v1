...
def get_financial_report_industry_y_banking():
    ...
    d_json_y_bs_banking = get_json_all(d_url_y_bs_banking, headers_tcbs)
    d_json_y_ic_banking = get_json_all(d_url_y_ic_banking, headers_tcbs)
    d_json_y_ratio_banking = get_json_all(d_url_y_ratio_banking, headers_tcbs)
    ...
    return df_y_bs_banking, df_y_ic_banking, df_y_ratio_banking
